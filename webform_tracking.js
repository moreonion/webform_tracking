        ...
        attach: function(context) {
            ...
            for (var key in values) {
                if (values.hasOwnProperty(key)) {
                    ...
                    result = typeof parameters[google] !== 'undefined'
                        ? parameters[google]: result;
                    result = typeof parameters[alias] !== 'undefined'
                        ? parameters[alias]: result;
                    result = typeof parameters[key] !== 'undefined'
            ...
            if (typeof tracking_data['external_referer'] === 'undefined') {
                if (document.referrer.indexOf(base_url) !== 0) {
                    tracking_data['external_referer'] = document.referrer;
                         ...
                         typeof parameters['external_referer'] !== 'undefined' &&
                         parameters['external_referer'].indexOf(base_url) !== 0) {
                    tracking_data['external_referer'] =
                        parameters['external_referer'];
                }
            }
